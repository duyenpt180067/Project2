				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<!-- <a href="initAddOrders.htm" class="add"><button
									class="btn btn-info">
									Add Orders <i class="fas fa-plus"></i>
								</button></a> -->
						</div>
						<!-- /.card-header -->
						<div class="card-body">
											...
											<thead>
												<tr role="row">
													<th class="sorting" tabindex="0" aria-controls="example2"
														rowspan="1" colspan="1"
														aria-label="Engine version: activate to sort column ascending">Order Id</th>
													<th class="sorting" tabindex="0" aria-controls="example2"
														rowspan="1" colspan="1"
													...
													<th class="sorting" tabindex="0" aria-controls="example2"
														rowspan="1" colspan="1"
														aria-label="Engine version: activate to sort column ascending">Order Status</th>
													<th class="sorting" tabindex="0" aria-controls="example2"
														rowspan="1" colspan="1"
											...
											<tbody>
												<c:forEach items="${listOrderss }" var="order">
													<tr role="row" class="odd">
														...
														<td>${order.phone }</td>
														<td id="${order.orderId }">${order.orderStatus }</td>
														<td><a id="${order.orderId }-status"
															href="initUpdateOrders.htm?orderId=${order.orderId }"><button
																	class="btn btn-warning">Update</button></a> <%-- <a
															href="deleteOrders.htm?orderId=${order.orderId }"><button
																	class="btn btn-danger">Delete</button></a> --%>
															<a href="detailOrder.htm?orderId=${order.orderId }"><button
