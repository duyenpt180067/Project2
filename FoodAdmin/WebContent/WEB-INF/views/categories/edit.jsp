			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Update Catalog</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card card-primary">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<f:form action="updateCategory.htm" modelAttribute="CategoryUp">
								<div class="card-body">
									<div class="form-group">
										<label for="caid">Catalog Id</label>
										<f:input type="text" path="caId" readonly="true" class="form-control"/>
									</div>
									<div class="form-group">
										<label for="name">Catalog Name</label>
										<f:input type="text" path="caName" class="form-control"/>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col-3">
												<input type="file" id="imageURL" value="${ CategoryUp.imageUrl}" class="form-control" style="padding: 0;height: 32px;"/>
										...
										<img src= "${ CategoryUp.imageUrl}" class="imgShow" style="width:175px;margin-top: 25px;" />
									</div>
								</div>
								<!-- /.card-body -->
